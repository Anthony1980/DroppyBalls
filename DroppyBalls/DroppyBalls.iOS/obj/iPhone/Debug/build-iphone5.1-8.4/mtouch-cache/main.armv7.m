...
extern void *mono_aot_module_DroppyBalls_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_DroppyBalls_iOS_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "DroppyBalls.iOS.exe";
